...
📖 **New here? Start with the [usage tutorial](TUTORIAL.md)** — a hands-on,
runnable walkthrough from a single decaying qubit to hybrid spin–cavity systems,
templates, pulses, and QEC.
